...
def evaluate(labels, predictions):
    ...
    """
    true_positives = sum((1 for true, pred in zip(labels, predictions) if true == pred == 1))
    true_negatives = sum((1 for true, pred in zip(labels, predictions) if true == pred == 0))
